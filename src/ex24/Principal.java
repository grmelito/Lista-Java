...
public class Principal {
	...
	public static void main(String[] args) {
	    ...
	    Bonificacao colaborador3 = new Bonificacao("Caio", 2250.00, 3);
	    Bonificacao colaborador4 = new Bonificacao("Simone", 3000.00, 1);
	    Bonificacao colaborador5 = new Bonificacao("Sanchez", 3000.00, 4);
	    Bonificacao colaborador6 = new Bonificacao("Bia", 1750.00, 3);
